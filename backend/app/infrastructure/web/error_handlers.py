...
_STATUS_BY_ERROR = {
    ...
    InvalidConversationScope: _HTTP_422,
    InvalidConversationMode: _HTTP_422,
    InvalidConversationTitle: _HTTP_422,
    ConversationTargetUnavailable: status.HTTP_409_CONFLICT,
    ConversationTurnConflict: status.HTTP_409_CONFLICT,
    ConversationClosed: status.HTTP_409_CONFLICT,
    ...
    QuizReviewNotUndoable: status.HTTP_409_CONFLICT,
