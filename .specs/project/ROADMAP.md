...
| `v5-generation-denoise` | C | Multi-run Sonnet-vs-Opus A/B, per-metric variance | Built (PR pending) — de-noised STAY on `claude-sonnet-5` (3 runs × 2 arms, all ties under the range rule); committed study runner closes the uncommitted-driver gap |
